...
const Footer = () => {
  ...
  return (
    <footer className="relative bg-white dark:bg-gray-900 pt-0 pb-8 transition-colors duration-300">
      {/* Gradient Border Top */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
        <div className="flex flex-col items-center gap-8">
          ...
          <div className="text-center space-y-2">
            <h2 className="text-3xl md:text-4xl font-bold font-heading bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-400">
              Get in touch
            </h2>
            <p className="text-gray-600 dark:text-gray-400 font-sans">
              Feel free to reach out via email, I'm just one email away
            </p>
          </div>
            ...
            <div className="relative min-w-[220px] sm:min-w-[230px]">
              ...
              >
                <input
                  ...
                  readOnly
                  className="bg-transparent border-none outline-none text-gray-700 dark:text-gray-300 text-sm md:text-base cursor-pointer w-full pr-2 font-sans"
                />
          ...
          <div className="mb-8 md:mb-0 text-center text-sm text-gray-500 dark:text-gray-400 font-sans">
